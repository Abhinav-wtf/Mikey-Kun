...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text("<code>Cheking status of this gangster..</code>", parse_mode=ParseMode.HTML)

    text = (
        f"╔═━「<b> Appraisal result:</b> 」\n"
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis user is member of 'Managers'."
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nThe Disaster level of this person is 'Commander'."
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\nThe Disaster level of this person is 'Vice Commander'."
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\nThe Disaster level of this person is 'Vice Captain'."
        disaster_level_present = True
...
def stats(update, context):
    ...
    status = "*╒═══「 Mikey System Statistics 」*\n\n"
    ...
    try:
        update.effective_message.reply_text(
            ...
            + f"\n\n✦ [Support](https://t.me/MikeyXSupport) | ✦ [Updates](http://t.me/MikeyXUpdates)\n\n"
            + "╘══「 By [MIKEY](https://t.me/mikey_kun90) 」\n",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
